...
cCubeMan2::cCubeMan2()
	: m_pRoot(NULL),
	m_pTexture(NULL),
	m_Destination_Index(2), m_Currunt_Index(0)
{
...
void cCubeMan2::RecieveHexaVertext(std::vector<ST_PC_VERTEX> *vertext)
{
	m_vHexagon = *vertext;

}

void cCubeMan2::Setup()
{
	cCharacter::Setup();
